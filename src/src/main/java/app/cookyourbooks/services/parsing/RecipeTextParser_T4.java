...
/**
 * Mutant T4: Don't parse servings — always set to null.
 *
 * <p>Tests that students provide recipe text with "Makes N" or "Serves N" and verify parsed
 * servings.
 */
public final class RecipeTextParser_T4 {
  ...
  public RecipeTextParser_T4() {
    this.ingredientParser = new IngredientParser();
  }

  public RecipeTextParser_T4(IngredientParser ingredientParser) {
  ...
  public @NonNull Recipe parse(@NonNull String recipeText) throws ParseException {
    ...
    // MUTANT T4: always set servings to null regardless of input
